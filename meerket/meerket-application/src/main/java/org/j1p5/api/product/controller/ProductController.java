...
public class ProductController {
    ...
    public Response<CursorResult<ProductResponseInfo>> getCompletedProducts(
            @CursorDefault Cursor cursor, @LoginUser Long userId) {

        CursorResult<ProductResponseInfo> completedProducts =
                productService.getCompletedProducts(userId, cursor);
    ...
    public Response<CursorResult<ProductResponseInfo>> getProductByCategory(
    ...
    @GetMapping("/my")
    public Response<CursorResult<MyProductResponseDto>> getMyProducts(
            @LoginUser Long userId,
            @CursorDefault Cursor cursor,
    ...
    @GetMapping("/keywords")
    private Response<CursorResult<ProductResponseInfo>> getProductByKeyword(
    ...
    public Response<CloseEarlyResponseDto> closeEarly(
            @PathVariable(name = "productId") Long productId, @LoginUser Long userId) {
    ...
    public Response<Void> markProductAsCompleted(
            @PathVariable Long productId, @LoginUser Long userId) {
