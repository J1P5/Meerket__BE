...
public record ProductResponseDetailInfo(
        ...
        Long myAuctionId) {
    public static ProductResponseDetailInfo of(
            ProductEntity product,
            UserEntity user,
            AuctionEntity winningAuction,
        ...
        return new ProductResponseDetailInfo(
                ...
                isSeller,
                winningAuction != null
                        ? winningAuction.getPrice()
                        : null, // 입찰 최고가 표시 -> 판매자 입장에서 보여주면 됨.
                myAuction != null ? myAuction.getId() : null);
    }
}
