...
public class FcmServiceImpl implements FcmService {
    ...
    @Override
    public void sendPushChatMessageNotification(Long receiverId, String senderNickname, String content) {
        try {
            FcmTokenEntity fcmTokenEntity = fcmTokenRepository.findByUserId(receiverId)
